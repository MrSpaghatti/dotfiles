...
export PATH=$GOPATH/bin:$GOROOT/bin:$HOME/.local/bin:$PATH #go
export PATH=$PATH:/home/spag/.pdtm/go/bin #pdtm
export PATH=$PATH:/home/spag/.asdf/bin #asdf
export ZSH="$HOME/.oh-my-zsh"
export ASDF_DATA_DIR="$HOME/.asdf"
export PATH=$PATH:/home/spag/.dotnet #dotnet
...
alias zrc='source $HOME/.zshrc && sleep 1 && zsh'
alias ls='eza -a --color=tty'
alias ff=fastfetch
alias cat=bat
alias man=tldr
